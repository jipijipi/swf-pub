...
const soumettreContent = `<div class="container row" id="content-page">
...
<div id="hero-container" class="row">
    <div id="hero">
        ...
        <p class="font-md">Nous vous accompagnons à chaque étape de votre campagne de <br>financement participatif
            pour
...
<div class="row">
    <div class="col-md-4 box-over-under-framed text-center">
        ...
        <br><span data-gtm-vis-recent-on-screen10563913_50="194" data-gtm-vis-first-on-screen10563913_50="194"
            data-gtm-vis-total-visible-time10563913_50="100" data-gtm-vis-has-fired10563913_50="1">ticket
            moyen</span>
    </div>
    <div class="col-md-4 box-over-under-framed text-center">
        ...
        <section id="featuresEntrepreneur">
            ...
            <div class="corporateFeature row">
                ...
                <div class="contentFeature col-md-7">
                    ...
                    <p class="paragraphFeature">Un accompagnement professionnel à toutes les étapes de votre
                        campagne :
            ...
            <div id="labels" class="text-center">
                ...
                <a href="http://www.franceangels.org" target="_blank">
                    <img class="lazyload" alt="France Angels"
                        src="https://d3i3cp443mmogz.cloudfront.net/public/entrepreneur/france-angels.svg"
                        width="120" height="120">
                </a>

                <a href="/guide-crowdfunding/financement-croissance-verte" target="_blank">
                    <img class="lazyload" alt="Croissante verte"
                        src="https://d3i3cp443mmogz.cloudfront.net/public/entrepreneur/croissance-verte.svg"
                        width="120" height="120">
                </a>
...
<section class="box row-layout" id="sowefund-team">
    <div class="box-block">
  ...
  " src="https://storage.googleapis.com/swf-bucket/illustrations/sowefund-team.png" width="300">
        ...
        <div id="team-description">
            <p>Depuis 2014, Sowefund est la plateforme pionni&egrave;re du financement participatif en France. Nous
                ...
                d&rsquo;investissement professionels).&nbsp;</p>
            <p>Sowefund, c&rsquo;est avant tout une &eacute;quipe de passionn&eacute;s et de sp&eacute;cialistes du
                financement de l&rsquo;innovation.</p>
            <p><br></p>
            <p>Apr&egrave;s avoir atteint la rentabilit&eacute;, d&eacute;pass&eacute; les 100 startups
                financ&eacute;es
                et s&rsquo;&ecirc;tre impos&eacute; comme leader de l&rsquo;investissement en amor&ccedil;age, nous
                rejoignons le groupe Founders en 2023 pour se donner les moyens de nos ambitions et vous apporter
                les
                meilleures m&eacute;thodes et process d&rsquo;investissement.&nbsp;</p>
            <p><br></p>
            <p>Cette alliance marque un tournant crucial dans notre histoire. Nos fondateurs, Benjamin Wattinne et
                ...
                l&rsquo;un des premiers business angels de France, pour accompagner toujours plus de startups dans
                leur
                d&eacute;veloppement. C&rsquo;est le d&eacute;but d&rsquo;une nouvelle &egrave;re !&nbsp;</p>
            <p><br></p>
            <p>Notre nouveau groupe repr&eacute;sente :</p>
            <ul>
                <li>
                    <p>plus de 250 soci&eacute;t&eacute;s financ&eacute;es</p>
                </li>
                <li>
                    <p>plus de 300 millions d&rsquo;euros d&eacute;di&eacute;s aux entreprises de croissance
                        &agrave; mi
                        2023</p>
                </li>
                <li>
                    <p>plus de 4000 employ&eacute;s dans les soci&eacute;t&eacute;s du portefeuille</p>
                </li>

            </ul>
            <p><br></p>
            <p>Avec le groupe Founders Future, nous sommes déjà à l’origine du succès de startups comme Lydia, Yuka,
                ekWateur, Teads, Lunii,Axioma, Agriloops ou Epicery.&nbsp;</p>
            <p><br></p>
            <div id="teamPartnersLogos"></div>
            <p><br></p>
            <p>Notre mission est double :&nbsp;</p>
            <p><br></p>
            <ol>
                <li>
                    <p>Pour vous investisseurs, vous permettre &agrave; tous de devenir actionnaires des entreprises
                        innovantes les plus prometteuses, aux c&ocirc;t&eacute;s d&rsquo;investisseurs
                        professionnels du
            ...
            <ol>
                <li ">
                    <p>Nous sommes au service de la cr&eacute;ation de valeur en accompagnant les fondateurs
                        ...
                        avec les meilleurs r&eacute;seaux de business angels afin de venir en compl&eacute;ment de
                        votre
                        lev&eacute;e.&nbsp;</p>
                </li>
            </ol>
            ...
            <p>Sowefund, c&rsquo;est l&rsquo;audace du capital-risque, la p&eacute;dagogie d&rsquo;une fintech
                ...
                fiabilit&eacute; d&rsquo;une solution agr&eacute;&eacute;e.</p>
        </div>
    </div>
</section>
...
<h1 class=" row-layout" id="title-team">L'équipe Sowefund</h1>
                    ...
                    <div class="row our-cards team-4" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Georges VIGLIETTI
                                <small class="upper">Co-fondateur | Président</small>
                            </h2>
                            <p class="font-xs">
                                Diplômé en management et en entrepreneuriat à l’ESCP Europe (MS « Innover et
                                entreprendre »), Georges
                                dirigea le réseau Paris Business Angels (plus grand réseau de BA en Europe) pendant
                                5 ans et est
                                désormais un des experts dans la gestion de ces réseaux. Il est également coach de
                                start ups à l'ESCP
                                Europe.

                                <br><a target="_blank" href="http://fr.linkedin.com/in/georgesviglietti/fr">Profil
                                    Linkedin</a>

                            </p>
                        </article>
                        <div class="row col-md-6 omega-md text-center hidden-sm">

                            <div>
                                <br>
                                <br>
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="http://fr.linkedin.com/in/georgesviglietti/fr">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-5" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Benjamin WATTINNE
                                <small class="upper">Co-fondateur | Dir. Général</small>
                            </h2>
                            <p class="font-xs">
                                Serial Entrepreneur et jeune Business Angel, Benjamin a dirigé Gust Europe jusqu'en
                                2014. Titulaire d'un
                                Master en Management de l’Innovation à Novancia, Benjamin est membre/intervenant de
                                la chaire
                                entrepreneuriale de HEC, ESCP Europe, Advancia et ESIEE Management.

                                <br><a target="_blank" href="http://fr.linkedin.com/in/bwattinne/fr">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="http://fr.linkedin.com/in/bwattinne/fr">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-6" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Jean-Philippe LEFLOT
                                <small class="upper">Co-fondateur | Dir. Marketing</small>
                            </h2>
                            <p class="font-xs">
                                Spécialiste en marketing avec plus de 10 ans d’expérience en communication visuelle,
                                diplômé en
                                marketing et en management de la nouvelle économie. Il a été un des acteurs clés à
                                la création du blog
                                leader "Good Morning Crowdfunding"

                                <br><a target="_blank" href="http://fr.linkedin.com/in/jpleflot/fr">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="http://fr.linkedin.com/in/jpleflot/fr">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-132" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Anne PERRIN
                                <small class="upper">Responsable Communication</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée d’un Master en école de Communication et après plusieurs expériences en
                                communication, Anne a
                                rejoint l’équipe pour être en charge de la gestion stratégique et opérationnelle du
                                Pôle Communication.
                                Elle est notamment en charge de la mise en place de la communication de marque, de
                                l’accompagnement des
                                entrepreneurs et de la communication du Fundtruck.

                                <br><a target="_blank"
                                    href="https://www.linkedin.com/in/anne-perrin-81552b6a/">Profil Linkedin</a>
                    ...
                    <div class="row our-cards team-37" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Chloé BUVET
                                <small class="upper">Customer Success Manager</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée de la Sorbonne et suite à plusieurs expériences dans des startups, Chloé a
                                rejoint l’équipe
                                Sowefund en tant qu’Happiness Manager et se charge de la communauté Sowefund.

                                <br><a target="_blank" href="https://www.linkedin.com/in/chloebuvet/">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="https://www.linkedin.com/in/chloebuvet/">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-485" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Gary COHEN
                                <small class="upper">Responsable Commercial</small>
                            </h2>
                            <p class="font-xs">
                                Passionné par la tech, les techniques de vente et la négociation, il a occupé
                                plusieurs postes en
                                commercial à Paris et à New York. Diplômé d'une double majeur en Business
                                Development et Digital
                                Business &amp; IT d'Audencia Business School, Gary est en charge des investissements
                                réalisés par notre
                                communauté d'investisseurs et de la prospection de sociétés à fort potentiel
                                destinées à être présentées
                                à notre communauté.

                                <br><a target="_blank"
                                    href="https://www.linkedin.com/in/gary-cohen-862227100/">Profil Linkedin</a>
                    ...
                    <div class="row our-cards team-9" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Yavna JAHADJEE
                                <small class="upper">Directrice d'investissement</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée d’un Master en Droit des affaires et issue du Mastère Spécialisé Finance
                                Risque et Contrôle à
                                Audencia, Yavna a rejoint l’équipe en tant que Directrice des Investissements de la
                                plateforme. Elle est
                                notamment chargée de la sélection des projets, du sourcing, de la préparation des
                                campagnes et du suivi
                                du portefeuille des investissements.

                                <br><a target="_blank"
                                    href="https://www.linkedin.com/in/yavna-jahadjee-516556142">Profil Linkedin</a>
                    ...
                    <div class="row our-cards team-935" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Nelson LOPES
                                <small class="upper">Responsable administratif et financier</small>
                            </h2>
                            <p class="font-xs">
                                Diplômé d'un master en Ingénierie Financière à la Sorbonne et suite à plusieurs
                                expériences dans
                                l'écosystème de l'innovation, Nelson rejoint l'aventure Sowefund en tant que
                                Responsable administratif
                                et financier.

                                <br><a target="_blank" href="https://www.linkedin.com/in/nelson-lopes7/">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="https://www.linkedin.com/in/nelson-lopes7/">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-1169" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Mathilde FOURNIER
                                <small class="upper">Responsable événementiel et partenariats</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée d'un MBA en événementiel, Mathilde est chef de projet événementiel pendant
                                2 ans dans des
                                agences de communication puis commerciale et account manager durant 3 ans chez
                                Doctolib avant de
                                rejoindre Sowefund comme responsable événementiel et partenariat, prinicipalement
                                pour le concours
                                Fundtruck.

                                <br><a target="_blank" href="https://www.linkedin.com/in/fourniermathilde/">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="https://www.linkedin.com/in/fourniermathilde/">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-1168" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Clarisse VIEL
                                <small class="upper">Chargée de Communication</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée d'un master en communication corporate, Clarisse est consultante en
                                communication et relations
                                presse dans une agence pendant trois ans avant de rejoindre Sowefund comme chargée
                                de communication de
                                marque.

                                <br><a target="_blank"
                                    href="https://www.linkedin.com/in/clarisse-viel-54b699138/">Profil Linkedin</a>
                    ...
                    <div class="row our-cards team-1170" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Marlène FRITCHE
                                <small class="upper">Account Manager</small>
                            </h2>
                            <p class="font-xs">
                                Diplômée d’un Master en Marketing et Communication et après plusieurs expériences
                                dans ce domaine et une
                                expérience entrepreneuriale, Marlène a rejoint l’équipe pour être en charge de
                                l'accompagnement en
                                communication des entrepreneurs en levée de fonds.

                                <br><a target="_blank" href="https://www.linkedin.com/in/marlene-fritche/">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="https://www.linkedin.com/in/marlene-fritche/">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-1175" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Célia CALDEIRA
                                <small class="upper">Commerciale</small>
                            </h2>
                            <p class="font-xs">
                    ...
                    <div class="row our-cards team-1173" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Leo SIBY
                                <small class="upper">Chargé de Relation Investisseurs</small>
                            </h2>
                            <p class="font-xs">
                    ...
                    <div class="row our-cards team-1171" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Dorian FROUGNEUX
                                <small class="upper">Chargé de Relation Investisseurs</small>
                            </h2>
                            <p class="font-xs">
                                ...
                                <br><a target="_blank" href="https://www.linkedin.com/in/dorian-frougneux/">Profil
                                    Linkedin</a>
                        ...
                        <div class="row col-md-6 omega-md text-center hidden-sm">
                            ...
                            <div>
                                ...
                                <br>
                                <a target="_blank" class="btn btn-primary btn-xl link-next"
                                    href="https://www.linkedin.com/in/dorian-frougneux/">Profil Linkedin</a>
                            </div>

                        </div>
                    </div>

                    <div class="row our-cards team-1172" style="display: none;">
                        <article class="col-xs-12 col-md-6 row">
                            <h2>Emma SCHULDT
                                <small class="upper">Chargée de communication</small>
                            </h2>
                            <p class="font-xs">
                                ...
                                <br><a target="_blank"
                                    href="https://www.linkedin.com/in/emma-schuldt-communication-marketing/">Profil
                                    Linkedin</a>
    ...
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            ...
                            data-gtm-vis-recent-on-screen10563913_87="193"
                            data-gtm-vis-first-on-screen10563913_87="193"
                            data-gtm-vis-total-visible-time10563913_87="100" data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Georges VIGLIETTI"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/67a3ea3b-35be-4c36-a27b-069fab14aa31.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-5"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Benjamin WATTINNE"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/6f0abeb0-80e4-4d12-b6d9-1fa5b4f0008b.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-6"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Jean-Philippe LEFLOT"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/f84b0f5c-5703-4fde-9a35-cf1355b4708b.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-132"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Anne PERRIN"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/0e1cef88-cb98-4c1d-994e-a3a422cf972c.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-37"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Chloé BUVET"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/7f3e5c46-3dc9-40cd-91ec-cef7b9446f11.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-485"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Gary COHEN"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/6de659fd-383e-415f-9ad8-35b10c65555b.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-9"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Yavna JAHADJEE"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/e57f3334-858e-480d-9ef3-be20096c498b.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-935"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Nelson LOPES"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/45cd559c-6b1d-4256-9484-4d5075ff6e6f.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-1169"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Mathilde FOURNIER"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/9963c7d8-5945-4060-8e84-626e0a4f0dc0.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-1168"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Clarisse VIEL"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/d12d5cfb-a324-45f9-8c87-e1b0de66c80c.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-1170"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">


                                <img alt="Marlène FRITCHE"
                                    src="https://storage.googleapis.com/swf-prod-public/inputs/members/8fdae89f-8311-42e2-987a-71146782231b.jpg">
    ...
    height: 312px;
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                            data-showhide-no-doubletrigger="" data-showhide-target=".team-1175"
                            data-gtm-vis-has-fired10563913_87="1">
                            <div class="box-head">
    ...
    background-position: center;" class="vignette vignette-move vignette-grid show-hide portrait"
                    ...
                    <div class="row text-center">
                        <a href="/register" class="btn btn-xl btn-primary link-next click-spinning"
                            title="">S'inscrire gratuitement</a>
                    </div>
...
<div id="filter-bar" class="col-xs-3">
    <div id="opportunity-filter" class="filter-group">
        ...
        <div>
            ...
            <div id="toutes" onclick="toutes()" class="filter-btn">
                Tout voir
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-tous.svg" alt="icone tous">
            </div>

        </div>
    </div>
    <div id="focus-filter" class="filter-group">

        <p>Focus</p>

        <div>

            <div id="lastDays" onclick="lastDays()" class="filter-btn">
                Derniers jours
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-lastdays.svg"
                    alt="icone derniers jours">
            </div>


            <div id="impact" onclick="impact()" class="filter-btn">
                Impact
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-impact.svg"
                    alt="icone impact">
            </div>

        </div>
    </div>
    <div id="maturity-filter" class="filter-group">

        <p>Maturité</p>

        <div>

            <div id="PreSeed" onclick="preSeed()" class="filter-btn">
                Pre-seed
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-preseed.svg"
                    alt="icone pre-seed">
            </div>


            <div id="Seed" onclick="seed()" class="filter-btn">
                Seed
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-seed.svg" alt="icone seed">
            </div>


            <div id="PreSerieA" onclick="preSerieA()" class="filter-btn">
                Pre-série A
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-preseriea.svg"
                    alt="icone pre-serie a">
            </div>


            <div id="SerieA" onclick="serieA()" class="filter-btn">
                Série A
                <img src="https://d3i3cp443mmogz.cloudfront.net/public/test/filtres/icon-seriea.svg"
                    alt="icone serie a">
            </div>

        </div>
    </div>
    <div id="search-bar" class="filter-group">

        <p>Recherche</p>

        <form action="#" id="control-filter-text" method="post">
            <div>
                <input type="text" name="text-filter">
                <button name="submit">
